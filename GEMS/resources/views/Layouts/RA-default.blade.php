...
<body class = "float-none flex flex-col min-h-screen bg-orange bg-cover">
    ...
    <ul class="space-y-2">
        <br>
         ...
         <li>
            <a href="{{route('RA-Bookings')}}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
