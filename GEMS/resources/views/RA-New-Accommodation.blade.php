...
<div class = "flex flex-col justify-center items-center">
  <h1 class = "p-2 text-4xl text-white bg-Dgreen rounded-lg border-2 border-gold hover:bg-Lgreen">New Accommodation</h1>
</div>
...
require dirname(__DIR__, 3).'/database/selectFuncs.php';
    ...
    <input type=\"text\" id=\"maxCap\" name=\"maxCap\" placeholder=\"e.g 500\" class=\"bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500\" required><br>";
