   ...
   <a href="{{route('Home')}}" class="flex items-center mb-4 sm:mb-0">
      ...
      <ul class="space-y-2">
        <br>
         ...
         <li>
            <a href="{{route('Regions')}}" class="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-black hover:text-white">
               ...
               <span class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium rounded-full bg-gray-700 text-gray-300">Regions</span>
            </a>
         </li>
         <li>
            <a href="{{route('Contact')}}" class="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-black hover:text-white">
         ...
         <li>
            <a href="{{route('Login')}}" class="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-black hover:text-white">
               <svg aria-hidden="true" class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
