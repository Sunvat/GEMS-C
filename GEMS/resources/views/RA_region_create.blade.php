...
<form action="/action_page.php" method="get" id="updateForm">
  ...
  <input type="text" id="locName" name="locName" placeholder="UBC,Gymnasium" class="rounded p-2"><br>
  ...
  <input type="text" id="desc" name="desc" placeholder="" class="rounded p-2"><br><br>
</form>
